...
2. On the **Compute Instances** tab, add a new compute instance, using the **CPU** virtual machine type and **STANDARD_DS11_V2** virtual machine size, and giving it a unique name. You'll use this VM as a development environment.
